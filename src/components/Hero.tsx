      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-[4rem] font-heading font-bold text-[var(--fg)] leading-[1.1] mb-6 tracking-tight">
            ...
            <div className="flex flex-wrap items-center gap-6 mb-16">
              <a 
                href="#contact"
                className="group flex items-center justify-center gap-2 bg-[var(--color-brand-orange)] hover:bg-[var(--color-brand-orange-light)] text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-[0_0_20px_rgba(244,94,34,0.3)] hover:shadow-[0_0_30px_rgba(244,94,34,0.5)]"
              >
              ...
              <a 
                href="#pricing"
                className="group flex items-center gap-2 text-[var(--fg)] font-semibold hover:text-[var(--color-brand-orange-light)] transition-colors"
              >
